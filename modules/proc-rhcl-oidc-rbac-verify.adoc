...
----
$ curl -H "Authorization: Bearer $ACCESS_TOKEN" http://talker-api.apps.$CLUSTER_DOMAIN/resources -i
----
+
.Example output
[source,text]
...
[source,terminal,subs="+quotes"]
----
$ curl -H "Authorization: Bearer $ACCESS_TOKEN" -X DELETE http://talker-api.$CLUSTER_DOMAIN/resources/123 -i
----
+
.Example output
[source,text]
...
[source,terminal,subs="+quotes"]
----
$ curl -H "Authorization: Bearer $ACCESS_TOKEN" http://talker-api.$CLUSTER_DOMAIN/admin/settings -i
----
+
.Example output
[source,text]
...
[source,terminal,subs="+quotes"]
----
$ curl -H "Authorization: Bearer $ACCESS_TOKEN" http://talker-api.$CLUSTER_DOMAIN/resources -i
----
+
.Example output
[source,text]
