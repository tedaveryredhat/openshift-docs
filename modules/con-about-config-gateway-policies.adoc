...
[TIP]
====
Use the `$ oc explain authpolicies` command to understand which authentication methods are supported when you use {prodname} on {ocp}. The in-cluster API documentation contains a lists all supported mechanisms.
====
