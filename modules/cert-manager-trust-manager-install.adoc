...
* You have enabled one of the following feature sets on your cluster: `TechPreviewNoUpgrade`, `DevPreviewNoUpgrade`, `CustomNoUpgrade`, `OKD`. For more information on enabling `TechPreviewNoUpgrade` feature, see "Enabling features using feature gates".
...
cert-manager-6c8ff7b6cd-hl8nj              1/1     Running   0          72m
cert-manager-cainjector-79db6c7967-fxtf5   1/1     Running   0          72m
cert-manager-webhook-7cbf4d59f8-9p2kd      1/1     Running   0          72m
trust-manager-547bb59b4b-hd6mv             1/1     Running   0          24s
----
+
The status of the pod `trust-manager-547bb59b4b-hd6mv` must be `Running`.
