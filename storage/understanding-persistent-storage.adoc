...
[role="_additional-resources"]
.Additional resources
* xref:../storage/using-container-storage-interface-csi#persistent-storage-csi-vsphere-rwx_persistent-storage-csi-vsphere.adoc#persistent-storage-csi-vsphere-rwx_persistent-storage-csi-vsphere[ReadWriteMany vSphere volume support]
